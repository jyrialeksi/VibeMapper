...
export const exampleMaps: ExampleMap[] = [
  // ── E-commerce Store ──────────────────────────────────────────────
  {
    ...
    nodes: [
      // Activities
      { id: 'activity-1', type: 'activity', position: { x: 0, y: Y.activity }, data: { title: 'Browse Products', description: 'Customers discover and explore the product catalog', acceptanceCriteria: [], cardType: 'activity', priority: 'must-have' } },
      { id: 'activity-2', type: 'activity', position: { x: X_SPACE * 3, y: Y.activity }, data: { title: 'Purchase', description: 'Cart management and checkout experience', acceptanceCriteria: [], cardType: 'activity', priority: 'must-have' } },
      // Steps
      { id: 'step-1-1', type: 'step', position: { x: 0, y: Y.step }, data: { title: 'Search & Filter', description: 'Find products by keyword, category, or attributes', acceptanceCriteria: [], cardType: 'step', priority: 'must-have' } },
      { id: 'step-1-2', type: 'step', position: { x: X_SPACE, y: Y.step }, data: { title: 'View Product', description: 'Inspect product details before buying', acceptanceCriteria: [], cardType: 'step', priority: 'must-have' } },
      { id: 'step-1-3', type: 'step', position: { x: X_SPACE * 2, y: Y.step }, data: { title: 'Reviews', description: 'Read and write product reviews', acceptanceCriteria: [], cardType: 'step', priority: 'must-have' } },
      { id: 'step-2-1', type: 'step', position: { x: X_SPACE * 3, y: Y.step }, data: { title: 'Manage Cart', description: 'Add, update, and remove items before checkout', acceptanceCriteria: [], cardType: 'step', priority: 'must-have' } },
      { id: 'step-2-2', type: 'step', position: { x: X_SPACE * 4, y: Y.step }, data: { title: 'Checkout', description: 'Complete the purchase with payment and shipping', acceptanceCriteria: [], cardType: 'step', priority: 'must-have' } },
      // Stories
      { id: 'story-1-1-1', type: 'storyCard', position: { x: 0, y: Y.must }, data: {
      ...
      { id: 'story-1-1-2', type: 'storyCard', position: { x: 0, y: Y.should }, data: {
      ...
      { id: 'story-1-2-1', type: 'storyCard', position: { x: X_SPACE, y: Y.must }, data: {
      ...
      { id: 'story-1-3-1', type: 'storyCard', position: { x: X_SPACE * 2, y: Y.must }, data: {
      ...
      { id: 'story-1-3-2', type: 'storyCard', position: { x: X_SPACE * 2, y: Y.could }, data: {
      ...
      { id: 'story-2-1-1', type: 'storyCard', position: { x: X_SPACE * 3, y: Y.must }, data: {
      ...
      { id: 'story-2-2-1', type: 'storyCard', position: { x: X_SPACE * 4, y: Y.must }, data: {
      ...
      { id: 'story-2-2-2', type: 'storyCard', position: { x: X_SPACE * 4, y: Y.should }, data: {
  ...
  // ── Blog Platform ─────────────────────────────────────────────────
  {
    ...
    nodes: [
      { id: 'activity-1', type: 'activity', position: { x: 0, y: Y.activity }, data: { title: 'Create Content', description: 'Authors write, edit, and manage blog posts', acceptanceCriteria: [], cardType: 'activity', priority: 'must-have' } },
      { id: 'activity-2', type: 'activity', position: { x: X_SPACE * 2, y: Y.activity }, data: { title: 'Read & Engage', description: 'Readers discover, read, and interact with content', acceptanceCriteria: [], cardType: 'activity', priority: 'must-have' } },
      { id: 'step-1-1', type: 'step', position: { x: 0, y: Y.step }, data: { title: 'Write Post', description: 'Compose and format blog content', acceptanceCriteria: [], cardType: 'step', priority: 'must-have' } },
      { id: 'step-1-2', type: 'step', position: { x: X_SPACE, y: Y.step }, data: { title: 'Publish', description: 'Review and publish finished content', acceptanceCriteria: [], cardType: 'step', priority: 'must-have' } },
      { id: 'step-2-1', type: 'step', position: { x: X_SPACE * 2, y: Y.step }, data: { title: 'Browse Posts', description: 'Discover and navigate published content', acceptanceCriteria: [], cardType: 'step', priority: 'must-have' } },
      { id: 'step-2-2', type: 'step', position: { x: X_SPACE * 3, y: Y.step }, data: { title: 'Interact', description: 'Comment, like, and bookmark posts', acceptanceCriteria: [], cardType: 'step', priority: 'must-have' } },
      { id: 'story-1-1-1', type: 'storyCard', position: { x: 0, y: Y.must }, data: {
      ...
      { id: 'story-1-2-2', type: 'storyCard', position: { x: X_SPACE, y: Y.could }, data: {
      ...
      { id: 'story-2-1-1', type: 'storyCard', position: { x: X_SPACE * 2, y: Y.must }, data: {
      ...
      { id: 'story-2-1-2', type: 'storyCard', position: { x: X_SPACE * 2, y: Y.should }, data: {
      ...
      { id: 'story-2-2-1', type: 'storyCard', position: { x: X_SPACE * 3, y: Y.must }, data: {
      ...
      { id: 'story-2-2-2', type: 'storyCard', position: { x: X_SPACE * 3, y: Y.should }, data: {
  ...
  // ── Task Manager ──────────────────────────────────────────────────
  {
    ...
    nodes: [
      { id: 'activity-1', type: 'activity', position: { x: 0, y: Y.activity }, data: { title: 'Manage Tasks', description: 'Create, organize, and prioritize work items', acceptanceCriteria: [], cardType: 'activity', priority: 'must-have' } },
      { id: 'activity-2', type: 'activity', position: { x: X_SPACE * 2, y: Y.activity }, data: { title: 'Collaborate', description: 'Team coordination, assignments, and notifications', acceptanceCriteria: [], cardType: 'activity', priority: 'must-have' } },
      { id: 'step-1-1', type: 'step', position: { x: 0, y: Y.step }, data: { title: 'Create Task', description: 'Define new work items with details', acceptanceCriteria: [], cardType: 'step', priority: 'must-have' } },
      { id: 'step-1-2', type: 'step', position: { x: X_SPACE, y: Y.step }, data: { title: 'Organize', description: 'Categorize and visualize tasks on boards', acceptanceCriteria: [], cardType: 'step', priority: 'must-have' } },
      { id: 'step-2-1', type: 'step', position: { x: X_SPACE * 2, y: Y.step }, data: { title: 'Assign & Track', description: 'Delegate work and monitor progress', acceptanceCriteria: [], cardType: 'step', priority: 'must-have' } },
      { id: 'step-2-2', type: 'step', position: { x: X_SPACE * 3, y: Y.step }, data: { title: 'Notify', description: 'Keep the team informed of changes', acceptanceCriteria: [], cardType: 'step', priority: 'must-have' } },
      { id: 'story-1-1-1', type: 'storyCard', position: { x: 0, y: Y.must }, data: {
      ...
      { id: 'story-1-2-2', type: 'storyCard', position: { x: X_SPACE, y: Y.should }, data: {
      ...
      { id: 'story-2-1-2', type: 'storyCard', position: { x: X_SPACE * 2, y: Y.could }, data: {
      ...
      { id: 'story-2-2-2', type: 'storyCard', position: { x: X_SPACE * 3, y: Y.could }, data: {
  ...
  // ── Fitness App ───────────────────────────────────────────────────
  {
    ...
    nodes: [
      { id: 'activity-1', type: 'activity', position: { x: 0, y: Y.activity }, data: { title: 'Work Out', description: 'Users find, perform, and log exercises', acceptanceCriteria: [], cardType: 'activity', priority: 'must-have' } },
      { id: 'activity-2', type: 'activity', position: { x: X_SPACE * 2, y: Y.activity }, data: { title: 'Track Progress', description: 'Monitor stats, set goals, and earn achievements', acceptanceCriteria: [], cardType: 'activity', priority: 'must-have' } },
      { id: 'step-1-1', type: 'step', position: { x: 0, y: Y.step }, data: { title: 'Choose Workout', description: 'Browse or build a workout routine', acceptanceCriteria: [], cardType: 'step', priority: 'must-have' } },
      { id: 'step-1-2', type: 'step', position: { x: X_SPACE, y: Y.step }, data: { title: 'Log Exercise', description: 'Record sets, reps, and cardio sessions', acceptanceCriteria: [], cardType: 'step', priority: 'must-have' } },
      { id: 'step-2-1', type: 'step', position: { x: X_SPACE * 2, y: Y.step }, data: { title: 'View Stats', description: 'Review performance charts and records', acceptanceCriteria: [], cardType: 'step', priority: 'must-have' } },
      { id: 'step-2-2', type: 'step', position: { x: X_SPACE * 3, y: Y.step }, data: { title: 'Set Goals', description: 'Define targets and track streaks', acceptanceCriteria: [], cardType: 'step', priority: 'must-have' } },
      { id: 'story-1-1-1', type: 'storyCard', position: { x: 0, y: Y.must }, data: {
