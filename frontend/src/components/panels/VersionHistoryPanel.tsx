...
export function VersionHistoryPanel() {
  ...
  return (
    <div className="absolute right-0 top-0 h-full w-80 bg-white border-l border-gray-200 shadow-lg z-50 flex flex-col">
      {/* Header */}
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        {versions.map((v) => (
          <div key={v.id} className="p-3 border-b border-gray-100 hover:bg-gray-50">
