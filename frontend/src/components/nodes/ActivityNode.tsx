...
export function ActivityNode({ id, data, selected }: NodeProps<Node<StoryCardData>>) {
  ...
  return (
    <div
      className={`px-3 py-2.5 rounded-lg shadow-md border-2 w-[260px] bg-purple-50 dark:bg-purple-950 ${
        selected ? 'border-purple-600 dark:border-purple-400 ring-2 ring-purple-300 dark:ring-purple-700' : 'border-purple-400 dark:border-purple-500'
      } ${highlightClass}`}
    >
      <div className="text-[8px] font-bold uppercase tracking-wider text-purple-600 dark:text-purple-400 mb-1">
        Activity
      </div>
